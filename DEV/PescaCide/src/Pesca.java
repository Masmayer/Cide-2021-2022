...
public class Pesca {
    ...
    boolean comprobarPesquera(String pathPesquera) throws Exception {
        if (pathPesquera.equals("src/mediterrania.txt") || pathPesquera.equals("src/florida.txt")){
            System.out.println("------------------------------\nMar seleccionado correctamente.\n------------------------------");
            return true;
        }else throw new Exception("El mar introducido no existe.");
